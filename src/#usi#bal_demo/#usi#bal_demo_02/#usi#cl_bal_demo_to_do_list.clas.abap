CLASS /usi/cl_bal_demo_to_do_list DEFINITION PUBLIC FINAL CREATE PUBLIC.
  PUBLIC SECTION.
    ...
    METHODS create_task
      IMPORTING i_task_text TYPE /usi/bal_demo_to_do_task_text
      RAISING   /usi/cx_bal_demo_root.
    ...
    METHODS read_task
      ...
      RETURNING VALUE(r_result) TYPE /usi/bal_demo_to_do_task
      RAISING   /usi/cx_bal_demo_root.
    ...
    METHODS read_tasks
      RETURNING VALUE(r_result) TYPE /usi/bal_demo_to_do_tasks
      RAISING   /usi/cx_bal_demo_root.
    ...
    "! @raising   /usi/cx_bal_demo_root | Not found
    METHODS update_task
      IMPORTING i_task TYPE /usi/bal_demo_to_do_task
      RAISING   /usi/cx_bal_demo_root.
  ...
  PRIVATE SECTION.
    ...
    METHODS log_info_message
      IMPORTING i_message_number     TYPE symsgno
    ...
    METHODS start_log
      IMPORTING i_sub_object  TYPE balsubobj
...
CLASS /usi/cl_bal_demo_to_do_list IMPLEMENTATION.
  METHOD constructor.
    ...
    IF tasks IS NOT INITIAL.
      ...
      ASSIGN tasks[ index_of_last_task ] TO <last_task>.
  ...
  METHOD create_itab_container.
    ...
    r_result = NEW #( i_internal_table = i_table
    ...
    TRY.
        ...
        TRY.
            ...
            RAISE EXCEPTION TYPE /usi/cx_bal_demo_duplicate
              EXPORTING textid = /usi/cx_bal_demo_duplicate=>duplicate_task_text
  ...
  METHOD get_tasks_by_text.
    ...
    tasks = to_do_list-dao_object->read_tasks( ).
    LOOP AT tasks ASSIGNING <task> WHERE text = i_task_text.
    ...
    TRY.
        ...
        RAISE EXCEPTION TYPE /usi/cx_bal_demo_not_found
          EXPORTING textid = /usi/cx_bal_demo_not_found=>task_not_found_by_text
  ...
  METHOD read_tasks.
    ...
    ELSE.
      ...
      TRY.
          RAISE EXCEPTION TYPE /usi/cx_bal_demo_not_found
            EXPORTING textid = /usi/cx_bal_demo_not_found=>no_tasks_found.
        CLEANUP INTO propagated_exception.
