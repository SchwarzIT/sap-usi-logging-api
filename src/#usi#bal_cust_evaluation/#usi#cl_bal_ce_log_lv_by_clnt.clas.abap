CLASS /usi/cl_bal_ce_log_lv_by_clnt DEFINITION PUBLIC FINAL CREATE PUBLIC.
  PUBLIC SECTION.
  ...
  PRIVATE SECTION.
    DATA customizing_dao TYPE REF TO /usi/if_bal_cd_log_lv_by_clnt.
    ...
    METHODS get_customizing_record
      ...
      RETURNING
        VALUE(r_result) TYPE /usi/if_bal_cd_log_lv_by_clnt=>ty_record
      RAISING
        /usi/cx_bal_root.
...
CLASS /usi/cl_bal_ce_log_lv_by_clnt IMPLEMENTATION.
  METHOD /usi/if_bal_ce_log_lv_by_clnt~get_auto_save_package_size.
    DATA customizing_record TYPE /usi/if_bal_cd_log_lv_by_clnt=>ty_record.
  ...
  METHOD /usi/if_bal_ce_log_lv_by_clnt~get_log_level.
    DATA customizing_record TYPE /usi/if_bal_cd_log_lv_by_clnt=>ty_record.
  ...
  METHOD get_customizing_record.
    DATA(customizing_entries) = customizing_dao->get_records( i_endda_range      = VALUE #( ( sign   = 'I'
                                                                                              option = 'GE'
                                                                                              low    = sy-datum ) )
