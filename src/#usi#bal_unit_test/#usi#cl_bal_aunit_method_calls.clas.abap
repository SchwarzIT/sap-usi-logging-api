CLASS /usi/cl_bal_aunit_method_calls DEFINITION PUBLIC FINAL CREATE PUBLIC FOR TESTING.
  PUBLIC SECTION.
    ...
    METHODS assert_method_called_n_times
      IMPORTING i_method_name              TYPE /usi/cl_bal_aunit_method_call=>ty_method_name
    ...
    METHODS get_method_calls
      IMPORTING i_method_name   TYPE /usi/cl_bal_aunit_method_call=>ty_method_name
      RETURNING VALUE(r_result) TYPE ty_method_calls.
    ...
    METHODS insert_method_call
      IMPORTING i_method_name   TYPE /usi/cl_bal_aunit_method_call=>ty_method_name
      RETURNING VALUE(r_result) TYPE REF TO /usi/cl_bal_aunit_method_call.
...
CLASS /usi/cl_bal_aunit_method_calls IMPLEMENTATION.
  METHOD assert_method_called_n_times.
    ...
    LOOP AT method_calls TRANSPORTING NO FIELDS WHERE method_name = i_method_name.
  ...
  METHOD get_method_calls.
    ...
    LOOP AT method_calls ASSIGNING <method_call> WHERE method_name = i_method_name.
