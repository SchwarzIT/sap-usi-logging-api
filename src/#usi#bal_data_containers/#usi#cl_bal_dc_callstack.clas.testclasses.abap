...
CLASS lcl_unit_tests_serialization DEFINITION FINAL CREATE PUBLIC FOR TESTING.
...
CLASS lcl_unit_tests_serialization IMPLEMENTATION.
  ...
  METHOD test_deserialize_valid_xml.
    ...
    " deserialize
    TRY.
        cut ?= /usi/cl_bal_dc_callstack=>/usi/if_bal_data_container~deserialize( serialized_data_container ).
      CATCH /usi/cx_bal_root INTO unexpected_exception.
        /usi/cl_bal_aunit_exception=>fail_on_unexpected_exception( unexpected_exception ).
    ENDTRY.
...
*--------------------------------------------------------------------*
CLASS lcl_unit_test_cardinality DEFINITION FINAL CREATE PUBLIC FOR TESTING.
  "#AU Risk_Level Harmless
  "#AU Duration   Short
  PRIVATE SECTION.
...
CLASS lcl_unit_test_classname IMPLEMENTATION.
  METHOD assert_returns_right_classname.
    ...
    actual_result   = /usi/cl_bal_dc_callstack=>/usi/if_bal_data_container~get_classname( ).
