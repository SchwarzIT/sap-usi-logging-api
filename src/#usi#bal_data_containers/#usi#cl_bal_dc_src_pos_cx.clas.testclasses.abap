...
CLASS lcl_unit_tests_serialization IMPLEMENTATION.
  ...
  METHOD test_deserialize_valid_xml.
    ...
    DATA(serialized_data_container) = NEW /usi/cl_bal_dc_src_pos_cx( input )->/usi/if_bal_data_container~serialize( ).
    DATA(cut) = CAST /usi/cl_bal_dc_src_pos_cx( /usi/cl_bal_dc_src_pos_cx=>/usi/if_bal_data_container~deserialize(
...
CLASS lcl_unit_test_classname IMPLEMENTATION.
  METHOD assert_returns_right_classname.
    ...
    actual_result   = /usi/cl_bal_dc_src_pos_cx=>/usi/if_bal_data_container~get_classname( ).
